...
const Stories = () => {
  return (
    <section className=" px-4 md:px-[90px] md:py-14 flex flex-col-reverse md:flex-row items-center gap-12">
      ...
      <div className="">
        ...
        <div className=" flex justify-center md:justify-normal gap-3 md:gap-5 mt-6">
